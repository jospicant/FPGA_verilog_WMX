    ...
    "graph": {
      "blocks": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "Tenemos un misma salida **f** que en este caso se produciría un corto, pero \nen estos casos se toma la ley del más fuerte y la salida que predomina es el **1**.\nPor lo que si se encuentra un **1** y un **0** en la misma salida, predomina el **1**.\n** la ley del más fuerte **",
            "readonly": true
          },
          "position": {
            "x": 160,
