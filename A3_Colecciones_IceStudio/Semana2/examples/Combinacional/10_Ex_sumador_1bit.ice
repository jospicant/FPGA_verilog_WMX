{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "f3b4f679-86fe-4a94-8273-c66f70e8cb45",
          "type": "basic.input",
          "data": {
            "name": "sw1",
            "pins": [
        ...
        {
          "id": "51bac174-6a60-46a4-acfa-3ede0bea6c04",
          "type": "basic.output",
          "data": {
            "name": "suma",
            "pins": [
        ...
        {
          "id": "15fce66d-d08e-49a9-a6a9-23ac1e0bb8e6",
          "type": "basic.input",
          "data": {
            "name": "sw2",
            "pins": [
        ...
        {
          "id": "b0d95077-2fb5-4bef-95c8-feb311fdbe6e",
          "type": "basic.output",
          "data": {
            "name": "carry",
            "pins": [
        ...
        {
          "id": "07fb287a-638e-4262-9550-474ad603aa35",
        ...
        {
          "id": "47b3e7eb-9952-4718-a027-33f65b1cbf1c",
          "type": "basic.code",
          "data": {
            "code": "supply1 uno;",
            "params": [],
      ...
      "wires": [
        {
          "source": {
            "block": "07fb287a-638e-4262-9550-474ad603aa35",
            "port": "60a34f03-13f2-48c9-a06e-5a52cea2c961"
          },
          "target": {
            "block": "51bac174-6a60-46a4-acfa-3ede0bea6c04",
            "port": "in"
          }
        },
        {
          "source": {
            "block": "f3b4f679-86fe-4a94-8273-c66f70e8cb45",
            "port": "out"
          },
          "target": {
            "block": "07fb287a-638e-4262-9550-474ad603aa35",
        ...
        {
          "source": {
            "block": "15fce66d-d08e-49a9-a6a9-23ac1e0bb8e6",
            "port": "out"
          },
          "target": {
            "block": "07fb287a-638e-4262-9550-474ad603aa35",
        ...
        },
        {
          ...
          "target": {
            "block": "b0d95077-2fb5-4bef-95c8-feb311fdbe6e",
            "port": "in"
          }
        },
        {
          "source": {
            "block": "47b3e7eb-9952-4718-a027-33f65b1cbf1c",
            "port": "uno"
          },
          "target": {
            "block": "07fb287a-638e-4262-9550-474ad603aa35",
