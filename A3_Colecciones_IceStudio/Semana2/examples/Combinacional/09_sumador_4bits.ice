{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "e12eca6e-7f07-4349-84fa-76c6f5e3db9b",
          "type": "basic.input",
          "data": {
            "name": "a0",
            "pins": [
        ...
        {
          "id": "24b249af-05ca-4016-b78b-3e8cbbcb6dfb",
          "type": "basic.output",
          "data": {
            "name": "s0",
            "pins": [
        ...
        {
          "id": "76717325-6e30-4065-90e5-89c5e4fcb3c7",
          "type": "basic.input",
          "data": {
            "name": "b0",
            "pins": [
        ...
        {
          "id": "4be91165-ba67-49dc-8d4d-432b79ef6de8",
          "type": "basic.input",
          "data": {
            "name": "Cin",
            "pins": [
        ...
        {
          "id": "1a08aa8c-0bfa-4586-ab06-74bc606375cf",
          "type": "basic.input",
          "data": {
            "name": "a1",
            "pins": [
        ...
        {
          "id": "69759002-fd86-466d-b813-118e4f712bcb",
          "type": "basic.output",
          "data": {
            "name": "s1",
            "pins": [
        ...
        {
          "id": "8bfabcea-6869-490a-a1ea-6db33c2f3180",
          "type": "basic.input",
          "data": {
            "name": "b1",
            "pins": [
        ...
        {
          "id": "328bd65b-ee9b-40bb-8a22-52893996e6f4",
          "type": "basic.input",
          "data": {
            "name": "a2",
            "pins": [
        ...
        {
          "id": "93c08176-b232-433f-ad45-0da2b229b60d",
          "type": "basic.output",
          "data": {
            "name": "s2",
            "pins": [
        ...
        {
          "id": "a4ed582d-62bf-4f11-b87e-91299e4074e8",
          "type": "basic.input",
          "data": {
            "name": "b2",
            "pins": [
        ...
        {
          "id": "2bb23484-0c2b-44b2-90e8-2b5fabd7a9b1",
          "type": "basic.input",
          "data": {
            "name": "a3",
            "pins": [
        ...
        {
          "id": "b90a585e-be1f-4c18-8a64-82f171fc4b0e",
          "type": "basic.output",
          "data": {
            "name": "s3",
            "pins": [
        ...
        {
          "id": "89352efe-ec6b-4bd8-8a46-259bfac0182d",
          "type": "basic.input",
          "data": {
            "name": "b3",
            "pins": [
        ...
        {
          "id": "83cbc5ef-8d7c-4513-ac46-867e5684edd0",
          "type": "basic.output",
          "data": {
            "name": "Cout",
            "pins": [
        ...
        {
          "id": "86da72ec-0890-4706-a40a-f25b49541ba2",
          "type": "d21cddaf417df46d578a9939be7c415770eb3744",
          "position": {
            "x": -24,
            "y": -128
          },
        ...
        {
          "id": "ba45ae48-7c58-41ef-8005-6709ca84bd36",
          "type": "d21cddaf417df46d578a9939be7c415770eb3744",
          "position": {
            "x": 144,
            "y": -16
        ...
        {
          "id": "dc4c1d0d-9ddb-443f-9703-8b0f87705b04",
          "type": "d21cddaf417df46d578a9939be7c415770eb3744",
          "position": {
            "x": 320,
            "y": 96
        ...
        {
          "id": "632ef341-fbd6-4231-a146-d7ee8fcfd8f8",
          "type": "d21cddaf417df46d578a9939be7c415770eb3744",
          "position": {
            "x": 504,
            "y": 200
        ...
        {
          "id": "a3ca1940-d52e-4c05-bd15-1f7f1aed401b",
          "type": "basic.info",
          "data": {
            "info": "# assign  &  always\n* Todas las sentencias **assign** y **always**  se ejecutan de forma concurrente\n* Las **DESCRIPCIONES ESTRUCTURALES** se utilizan para la interconexión de diferentes módulos\n* Las **DESCRIPCIONES ESTRUCTURALES** conforman una **JERARQUÍA DEL SISTEMA** que se diseña  \n",
            "readonly": true
          },
          "position": {
            "x": -192,
      ...
      "wires": [
        {
          "source": {
            "block": "e12eca6e-7f07-4349-84fa-76c6f5e3db9b",
            "port": "out"
          },
          "target": {
            "block": "86da72ec-0890-4706-a40a-f25b49541ba2",
            "port": "0ef95826-791a-45c8-b723-1a03ffaf34b5"
          }
        },
        {
          "source": {
            "block": "1a08aa8c-0bfa-4586-ab06-74bc606375cf",
            "port": "out"
          },
          "target": {
            "block": "ba45ae48-7c58-41ef-8005-6709ca84bd36",
            "port": "0ef95826-791a-45c8-b723-1a03ffaf34b5"
          }
        },
        {
          "source": {
            "block": "328bd65b-ee9b-40bb-8a22-52893996e6f4",
            "port": "out"
          },
          "target": {
            "block": "dc4c1d0d-9ddb-443f-9703-8b0f87705b04",
            "port": "0ef95826-791a-45c8-b723-1a03ffaf34b5"
          }
        },
        {
          "source": {
            "block": "2bb23484-0c2b-44b2-90e8-2b5fabd7a9b1",
            "port": "out"
          },
          "target": {
            "block": "632ef341-fbd6-4231-a146-d7ee8fcfd8f8",
            "port": "0ef95826-791a-45c8-b723-1a03ffaf34b5"
          }
        },
        {
          "source": {
            "block": "86da72ec-0890-4706-a40a-f25b49541ba2",
            "port": "22b9857e-d6d9-4567-b9e2-b15115edf371"
          },
          "target": {
            "block": "ba45ae48-7c58-41ef-8005-6709ca84bd36",
            "port": "624ee036-2f2a-4d10-a9c8-a3af1b051729"
          },
          "vertices": [
            {
              "x": 104,
        ...
        {
          "source": {
            "block": "76717325-6e30-4065-90e5-89c5e4fcb3c7",
            "port": "out"
          },
          "target": {
            "block": "86da72ec-0890-4706-a40a-f25b49541ba2",
            "port": "e41df916-8f24-4bf0-8512-9113401eff96"
          }
        },
        {
          "source": {
            "block": "4be91165-ba67-49dc-8d4d-432b79ef6de8",
            "port": "out"
          },
          "target": {
            "block": "86da72ec-0890-4706-a40a-f25b49541ba2",
        ...
        {
          "source": {
            "block": "8bfabcea-6869-490a-a1ea-6db33c2f3180",
            "port": "out"
          },
          "target": {
            "block": "ba45ae48-7c58-41ef-8005-6709ca84bd36",
        ...
        {
          "source": {
            "block": "a4ed582d-62bf-4f11-b87e-91299e4074e8",
            "port": "out"
          },
          "target": {
            "block": "dc4c1d0d-9ddb-443f-9703-8b0f87705b04",
        ...
        {
          "source": {
            "block": "89352efe-ec6b-4bd8-8a46-259bfac0182d",
            "port": "out"
          },
          "target": {
            "block": "632ef341-fbd6-4231-a146-d7ee8fcfd8f8",
        ...
        },
        {
          "source": {
            "block": "86da72ec-0890-4706-a40a-f25b49541ba2",
            "port": "60a34f03-13f2-48c9-a06e-5a52cea2c961"
          },
          "target": {
            "block": "24b249af-05ca-4016-b78b-3e8cbbcb6dfb",
            "port": "in"
          }
        },
        {
          ...
          "target": {
            "block": "69759002-fd86-466d-b813-118e4f712bcb",
            "port": "in"
          }
        },
        {
          ...
          "target": {
            "block": "93c08176-b232-433f-ad45-0da2b229b60d",
            "port": "in"
          }
        },
        {
          ...
          "target": {
            "block": "b90a585e-be1f-4c18-8a64-82f171fc4b0e",
            "port": "in"
          }
        },
        {
          ...
          "target": {
            "block": "83cbc5ef-8d7c-4513-ac46-867e5684edd0",
            "port": "in"
          }
        }
      ]
  ...
  "dependencies": {
    "d21cddaf417df46d578a9939be7c415770eb3744": {
      "package": {
        "name": "Sumador_1bit",
        "version": "1.0",
