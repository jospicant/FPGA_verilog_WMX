  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "2caf1eed-39b2-46d0-93d3-d0d94500377a",
          "type": "basic.output",
          "data": {
            "name": "c",
            "pins": [
        ...
        },
        {
          ...
          "type": "basic.code",
          "data": {
            "code": "//module posNeg(input reset, input clk, output [2:0] e,output c, output [2:0] f);\n\nreg [2:0] a=1;       //inicializo a cero, por defecto los sintetizadores inician a cero.\nreg [2:0] b=1;       //valor por defecto \nreg [2:0] d=0;\n\n\n// originalmente a = 7  b=5\n\nalways @(posedge reset)  // invierte cada vez q se pulsa SW1\n    d <= ~d;\n  \nalways @(posedge clk)    // reacciona con el flanco positivo\n    a <= a+1;\n\nalways @(negedge clk)    // reacciona con el flanco negativo (2 sg más tarde para un Periodo de 4 sg)\n    b <= b+1;\n\n\n//Son tres procedimientos distintos trabajando sobre señales distintas y funcionan los tres bien\n//Si tengo que variar las mismas señales deben de estar todas en el mismo procedimiento always\n\n\n\nassign e = a;      //Asignación\nassign f = b;\nassign c = d;\n\n//endmodule",
            "params": [],
            "ports": {
              "in": [
                {
      ...
      "wires": [
        ...
        },
        {
          ...
          "target": {
            "block": "2caf1eed-39b2-46d0-93d3-d0d94500377a",
            "port": "in"
          }
        }
      ]
