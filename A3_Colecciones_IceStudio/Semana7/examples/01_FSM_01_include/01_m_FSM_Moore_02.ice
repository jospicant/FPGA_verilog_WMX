    ...
    "graph": {
      "blocks": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "## Instanciando una máquina de estados FSM (Finite State Machine)\n\n* Módulo formado por la importación de un módulo verilog desde su **fichero *.v (01_moore.v)** mediante la directiva **@include**\n\n* Se instancia el módulo para crear nuestro módulo. **module my_moore1(clk,reset,inA,inB,OutA,OutB);**\n",
            "readonly": true
          },
          "position": {
            "x": 616,
