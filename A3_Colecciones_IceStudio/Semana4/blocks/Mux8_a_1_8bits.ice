  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "eacaf1e0-60a7-4986-ae74-29b651b3555e",
          "type": "basic.info",
          "data": {
            "info": "\n# MULTIPLEXOR 8 a 1 de 8 bits\n\n* **Copia el código** y simula en [DigitalJS](http://digitaljs.tilk.eu/)\n\n\nmodule mux8_to_1_8bits(i0,i1,i2,i3,i4,i5,i6,i7,s,o);  \n\n  input [7:0] i0,i1,i2,i3,i4,i5,i6,i7;  \n  input [2:0] s;   \n  output [7:0] o;  \n  \n//-- Multiplexor de 8 a 1,   \n//-- de 8 bits  \n\nassign o = (s == 3'h0) ? i0 :  \n           (s == 3'h1) ? i1 :  \n           (s == 3'h2) ? i2 :   \n           (s == 3'h3) ? i3 :  \n           (s == 3'h4) ? i4 :  \n           (s == 3'h5) ? i5 :  \n           (s == 3'h6) ? i6 :i7;  \n\nendmodule  \n \n",
            "readonly": true
          },
          "position": {
            "x": -200,
        ...
        "graph": {
          "blocks": [
            ...
            },
            {
              ...
              "type": "basic.code",
              "data": {
                "code": "//-- Multiplexor de 8 a 1, \n//-- de 8 bits\n\nassign o = (s == 3'h0) ? i0 :\n           (s == 3'h1) ? i1 :\n           (s == 3'h2) ? i2 : \n           (s == 3'h3) ? i3 :\n           (s == 3'h4) ? i4 :\n           (s == 3'h5) ? i5 :\n           (s == 3'h6) ? i6 :\n           (s == 3'h7) ? i7 : \n           3'h0;\n           \n//Aquí hay un error pero funciona\n",
                "params": [],
                "ports": {
                  "in": [
                    {
