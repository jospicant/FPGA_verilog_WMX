{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "db5e8b25-038c-4a68-addc-c5cce3c47690",
          "type": "basic.output",
          "data": {
            "name": "led",
            "range": "[7:0]",
        ...
        {
          "id": "9a8ff98b-5620-458f-a265-6573be444884",
          "type": "basic.output",
          "data": {
            "name": "tx",
            "pins": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "# valores definidos con signo\n* Si un dato lo definimos que hay que considerar **el signo**, debemos especificarlo con la palabra clave **signed**\n* Si está definido como **signed** el bit más significativo indica el signo y si es negativo lo expresa en Ca2\n* Exite un desplazamiento a la derecha posible **para indicar que trate como con signo** para que introduzca un 1 si era  \n  negativo o 0 en caso contrario ( pero debe haberse definido como **signed** ), usaremos  **>>>** en vez de **>>**\n \n* ( -86 ) =                 1010_1010 --> 0101_0101 + 1 --> 0101_0110 = 88\n* ( -86) >>> 1 --> **(-43)  1_1010_101**-->0010_1010+1 -->0010_1011 (43)   -86/2 = -43",
            "readonly": true
          },
          "position": {
            "x": 192,
        ...
        {
          "id": "b413c276-9e17-4709-ab0f-fcd77c0fdcaa",
          "type": "basic.info",
          "data": {
            "info": "* Si no defino como **signed**  aunque use **>>>** no me mantendría el signo  \n  y me introduciría un cero por la derecha en vez de un 1.\n* Prueba quitar signed, volver a cargar y ver la diferencia, dará 85 =0101_0101",
            "readonly": true
          },
          "position": {
            "x": 160,
        ...
        {
          "id": "ca3a1aaa-d2e1-40ce-9e8a-59bc723fb096",
        ...
        {
          "id": "90eea9a4-1949-4168-ac68-ef2e34c7518e",
      ...
      "wires": [
        {
          "source": {
            "block": "98e96e61-9e33-48ad-978b-10d632922ee7",
            "port": "out"
          },
          "target": {
            "block": "db5e8b25-038c-4a68-addc-c5cce3c47690",
            "port": "in"
          },
          "size": 8
        },
        {
          ...
          "target": {
            "block": "90eea9a4-1949-4168-ac68-ef2e34c7518e",
        ...
        {
          "source": {
            "block": "ca3a1aaa-d2e1-40ce-9e8a-59bc723fb096",
        ...
        },
        {
          ...
          "target": {
            "block": "9a8ff98b-5620-458f-a265-6573be444884",
            "port": "in"
          }
        }
      ]
