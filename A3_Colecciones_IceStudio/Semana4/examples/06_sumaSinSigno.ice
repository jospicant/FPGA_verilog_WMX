{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "a637a638-2448-4181-80b0-c61e249fe66f",
          "type": "basic.output",
          "data": {
            "name": "out",
            "range": "[7:0]",
        ...
        {
          "id": "c2314899-e951-406e-a596-412f50b99b71",
          "type": "basic.output",
          "data": {
            "name": "Tx",
            "pins": [
        ...
        {
          "id": "8d77709a-e657-41fe-9fc1-0142a431dd8c",
          "type": "basic.info",
          "data": {
            "info": "# out= 0000_1111",
            "readonly": true
        ...
        {
          "id": "29457e65-a1a1-421f-af10-8e32fda0d433",
          "type": "basic.info",
          "data": {
            "info": "\n* a y b están tratados sin signo ya que no se ha dicho lo contrario\n* la suma será una suma de dos números sin signo",
            "readonly": true
          },
          "position": {
            "x": 72,
        ...
        {
          "id": "546ce262-290a-43d2-834b-8b59e2938ce7",
      ...
      "wires": [
        ...
        },
        {
          ...
          "target": {
            "block": "a637a638-2448-4181-80b0-c61e249fe66f",
            "port": "in"
          },
          "size": 8
        },
        {
          "source": {
            "block": "546ce262-290a-43d2-834b-8b59e2938ce7",
            "port": "8736e205-f8cc-4294-84cf-5e81319571c6"
          },
          "target": {
            "block": "c2314899-e951-406e-a596-412f50b99b71",
            "port": "in"
          }
        },
        {
