    ...
    "graph": {
      "blocks": [
        ...
        },
        {
          ...
          "type": "basic.code",
          "data": {
            "code": "\n\nreg  [7:0] d;\nwire signed [3:0] a,b; // si quiero que trate con signo debe saberlo\n                       // hay qu indicarle q son números con signo (bit3 = signo )\n\nalways @(*)\n\nbegin:LABEL\n// Un bloque always necesita definir una etiqueta\n// si se realiza una declaracion local ( a1,b1,c1)\n\n reg signed [7:0] a1,b1,d1;  \n \n a1 = a;    // como sabe q a es con signo, esta asignación hace la extensión de signo\n b1 = b;    // a1=0000_0011   b1=1111_1011;  extensión de signo. \n\n d1 = a+b;  // 0000_0011 + 1111_1011  = 1111_1110 = -2 en Ca2   \n d  = d1;   \n               \n\nend",
            "params": [],
            "ports": {
              "in": [
                {
