{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "c0674923-8c47-4791-bad5-fdecce4fef65",
          "type": "basic.input",
          "data": {
            "name": "SDA",
            "pins": [
        ...
        {
          "id": "a6bdb8cd-44d3-42aa-8863-fc03b94cd3ba",
          "type": "basic.output",
          "data": {
            "name": "Slave_Master",
            "pins": [
        ...
        {
          "id": "1b532815-4754-4d63-a539-d9199739fb29",
          "type": "basic.output",
          "data": {
            "name": "Master_Slave",
            "pins": [
        ...
        {
          "id": "d9b47771-cca3-46f9-b1c4-413a3a45c0a5",
        ...
        {
          "id": "56652a4f-336b-4cc4-881e-8506cb122f30",
          "type": "basic.info",
          "data": {
            "info": "**SDA**",
            "readonly": true
      ...
      "wires": [
        {
          "source": {
            "block": "d9b47771-cca3-46f9-b1c4-413a3a45c0a5",
            "port": "fb217423-43bd-49af-8aae-fb0b0b38e24a"
          },
          "target": {
            "block": "a6bdb8cd-44d3-42aa-8863-fc03b94cd3ba",
            "port": "in"
          }
        },
        {
          "source": {
            "block": "d9b47771-cca3-46f9-b1c4-413a3a45c0a5",
            "port": "c54b22cd-e99e-4f18-ad03-518d91b20629"
          },
          "target": {
            "block": "1b532815-4754-4d63-a539-d9199739fb29",
            "port": "in"
          }
        },
        {
          "source": {
            "block": "c0674923-8c47-4791-bad5-fdecce4fef65",
            "port": "out"
          },
          "target": {
            "block": "d9b47771-cca3-46f9-b1c4-413a3a45c0a5",
      ...
      "design": {
        "graph": {
          "blocks": [
            ...
            {
              "id": "fb217423-43bd-49af-8aae-fb0b0b38e24a",
              "type": "basic.output",
              "data": {
                "name": "S_M",
                "pins": [
            ...
            {
              "id": "c54b22cd-e99e-4f18-ad03-518d91b20629",
              "type": "basic.output",
              "data": {
                "name": "M_S",
                "pins": [
          ...
          "wires": [
            ...
            },
            {
              "source": {
                "block": "f56d83b1-73c7-433d-810b-94107609ceb1",
                "port": "dc131315-eebe-4cfc-ac9a-7084d0ff411d"
              },
              "target": {
                "block": "fb217423-43bd-49af-8aae-fb0b0b38e24a",
                "port": "in"
              },
              "vertices": [
                {
            ...
            },
            {
              "source": {
                "block": "f56d83b1-73c7-433d-810b-94107609ceb1",
                "port": "e822d69a-69c6-4381-9a3c-2fc68c8d439d"
              },
              "target": {
                "block": "c54b22cd-e99e-4f18-ad03-518d91b20629",
                "port": "in"
              },
              "vertices": [
                {
      ...
      "design": {
        "graph": {
          "blocks": [
            ...
            {
              "id": "dc131315-eebe-4cfc-ac9a-7084d0ff411d",
              "type": "basic.output",
              "data": {
                "name": "S_M",
                "pins": [
            ...
            {
              "id": "e822d69a-69c6-4381-9a3c-2fc68c8d439d",
              "type": "basic.output",
              "data": {
                "name": "M_S",
                "pins": [
          ...
          "wires": [
            ...
            },
            {
              ...
              "target": {
                "block": "e822d69a-69c6-4381-9a3c-2fc68c8d439d",
                "port": "in"
              }
            },
            {
              ...
              "target": {
                "block": "dc131315-eebe-4cfc-ac9a-7084d0ff411d",
                "port": "in"
              }
            }
          ]
