{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "32c486f5-2e2f-430f-b39e-e5adf54b865d",
          "type": "basic.output",
          "data": {
            "name": "led",
            "range": "[7:0]",
        ...
        {
          "id": "d02b423f-4d6c-4768-8444-3d7f65f83115",
          "type": "basic.code",
          "data": {
            "code": "\nreg[7:0] q;\n\nalways @(posedge clk)\nbegin\nif (reset)  q <=0;\nelse        q <= q+1;\n\nend",
            "params": [],
        ...
        {
          "id": "12b5abe6-bbea-4b91-b0ee-1eed6ad8e053",
        ...
        {
          "id": "efb7f3f9-6856-4739-b0ec-8ac5a79d8adb",
      ...
      "wires": [
        {
          "source": {
            "block": "12b5abe6-bbea-4b91-b0ee-1eed6ad8e053",
            "port": "3d584b0a-29eb-47af-8c43-c0822282ef05"
          },
          "target": {
            "block": "d02b423f-4d6c-4768-8444-3d7f65f83115",
            "port": "reset"
          }
        },
        {
          ...
          "target": {
            "block": "32c486f5-2e2f-430f-b39e-e5adf54b865d",
            "port": "in"
          },
          "size": 8
        },
        {
          "source": {
            "block": "efb7f3f9-6856-4739-b0ec-8ac5a79d8adb",
