{
    ...
    "graph": {
      "blocks": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "* contador en Anillo.\n* Con la primera pulsación del SW1 se carga un 1 en Ch1 que se irá desplazando a la derecha  \n  con cada pulsación de SW1\n",
            "readonly": true
          },
          "position": {
            "x": 232,
        ...
        {
          "id": "aa909d06-8fb4-454d-8037-286153e056d2",
          "type": "3ec9b19fc401ca03a0c8296c91232a101d9f9635",
          "position": {
            "x": 808,
            "y": 208
          },
      ...
      "wires": [
        {
          ...
          "target": {
            "block": "aa909d06-8fb4-454d-8037-286153e056d2",
  ...
  "dependencies": {
    ...
    "3ec9b19fc401ca03a0c8296c91232a101d9f9635": {
      "package": {
        "name": "C_Anillo >> ",
        "version": "1.0",
        "description": "Contador en Anillo",
        "author": "jospicant ",
        "image": ""
      },
      "design": {
