{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "9d96c0d5-2d7d-4c55-8392-1b8c7cf506d6",
          "type": "basic.output",
          "data": {
            "name": "Ch1",
            "pins": [
        ...
        {
          "id": "7fcdfb3e-dee1-468b-97d5-271408652065",
          "type": "basic.output",
          "data": {
            "name": "Ch1",
            "pins": [
        ...
        {
          "id": "78baf176-2421-472c-9504-a596a3541efb",
          "type": "basic.output",
          "data": {
            "name": "Ch1",
            "pins": [
        ...
        {
          "id": "07a75a61-e7ae-4fa3-a895-97ff76d2c754",
          "type": "basic.input",
          "data": {
            "name": "in_PPM",
            "pins": [
        ...
        {
          "id": "9c50cef6-76d9-401c-90f4-3433ad731e27",
          "type": "basic.output",
          "data": {
            "name": "Ch1",
            "pins": [
        ...
        {
          "id": "dc0eaf93-e880-4db7-b0ee-f33873f75c5f",
          "type": "basic.input",
          "data": {
            "name": "SW2",
            "pins": [
        ...
        {
          "id": "26976714-11d5-4054-85b0-79ff235aa5b6",
          "type": "basic.output",
          "data": {
            "name": "Ch1",
            "pins": [
        ...
        {
          "id": "b58ea100-8352-455c-84af-7c25a34ad3cb",
          "type": "basic.output",
          "data": {
            "name": "Ch1",
            "pins": [
        ...
        {
          "id": "ceb2fe26-ea5f-4533-8692-8bae698fa43b",
          "type": "basic.output",
          "data": {
            "name": "Ch1",
            "pins": [
        ...
        {
          "id": "c27179f0-a73f-40e0-a540-cf1ef0049c0d",
          "type": "basic.output",
          "data": {
            "name": "Ch1",
            "pins": [
        ...
        {
          "id": "052834a0-6b84-481b-a785-7ec1676d0a5c",
          "type": "493b6d53caaf111c92a628ebdcb1cbdb38a61669",
          "position": {
            "x": 720,
            "y": 216
          },
        ...
        {
          "id": "aed79bfc-3960-4127-b68e-130405f00f06",
          "type": "basic.info",
          "data": {
            "info": "Test OK\n",
            "readonly": true
      ...
      "wires": [
        {
          "source": {
            "block": "052834a0-6b84-481b-a785-7ec1676d0a5c",
            "port": "0c6940eb-1d05-4142-884c-533e1dab5a93"
          },
          "target": {
            "block": "9d96c0d5-2d7d-4c55-8392-1b8c7cf506d6",
            "port": "in"
          },
          "vertices": [
            {
        ...
        },
        {
          ...
          "target": {
            "block": "7fcdfb3e-dee1-468b-97d5-271408652065",
            "port": "in"
          },
          "vertices": [
            {
        ...
        },
        {
          ...
          "target": {
            "block": "78baf176-2421-472c-9504-a596a3541efb",
            "port": "in"
          },
          "vertices": [
            {
        ...
        },
        {
          ...
          "target": {
            "block": "9c50cef6-76d9-401c-90f4-3433ad731e27",
            "port": "in"
          },
          "vertices": [
            {
        ...
        },
        {
          "source": {
            "block": "052834a0-6b84-481b-a785-7ec1676d0a5c",
            "port": "518e6dbd-f160-46e5-a665-8e27c67509b7"
          },
          "target": {
            "block": "26976714-11d5-4054-85b0-79ff235aa5b6",
            "port": "in"
          }
        },
        {
          "source": {
            "block": "052834a0-6b84-481b-a785-7ec1676d0a5c",
            "port": "ceee11dd-3453-444e-a323-19ce3725f78c"
          },
          "target": {
            "block": "b58ea100-8352-455c-84af-7c25a34ad3cb",
            "port": "in"
          }
        },
        {
          "source": {
            "block": "052834a0-6b84-481b-a785-7ec1676d0a5c",
            "port": "b095f1f1-7f00-4943-9114-0e8e04bc2e10"
          },
          "target": {
            "block": "ceb2fe26-ea5f-4533-8692-8bae698fa43b",
            "port": "in"
          },
          "vertices": [
            {
        ...
        },
        {
          "source": {
            "block": "052834a0-6b84-481b-a785-7ec1676d0a5c",
            "port": "f4b9a220-ea22-4440-b4ba-665afe2ffcb5"
          },
          "target": {
            "block": "c27179f0-a73f-40e0-a540-cf1ef0049c0d",
            "port": "in"
          },
          "vertices": [
            {
        ...
        {
          "source": {
            "block": "dc0eaf93-e880-4db7-b0ee-f33873f75c5f",
            "port": "out"
          },
          "target": {
            "block": "052834a0-6b84-481b-a785-7ec1676d0a5c",
            "port": "bbd71135-1936-4956-83f6-c025d2458e00"
          }
        },
        {
          "source": {
            "block": "07a75a61-e7ae-4fa3-a895-97ff76d2c754",
            "port": "out"
          },
          "target": {
            "block": "052834a0-6b84-481b-a785-7ec1676d0a5c",
  ...
  "dependencies": {
    "493b6d53caaf111c92a628ebdcb1cbdb38a61669": {
      "package": {
        "name": "Dec PPM 8",
        "version": "1.0",
        "description": "Módulo decodificador PPM de 8 bits",
        "author": "jospicant",
        "image": ""
      },
      "design": {
        "graph": {
          "blocks": [
            ...
            {
              "id": "18ee2999-2497-433d-8ffd-61144fb1dc94",
              "type": "basic.input",
              "data": {
                "name": "clk",
                "clock": true
          ...
          "wires": [
            ...
            {
              "source": {
                "block": "18ee2999-2497-433d-8ffd-61144fb1dc94",
                "port": "out"
              },
              "target": {
                "block": "b819c5e3-6b2f-47db-889e-10c7fd3871e3",
                "port": "6e432e07-631c-4cc0-a6e2-619f72322336"
              }
            },
            {
              "source": {
