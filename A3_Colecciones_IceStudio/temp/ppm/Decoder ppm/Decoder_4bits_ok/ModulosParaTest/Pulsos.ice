{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "5fd62d84-d7cd-4aff-93cc-a0ef14c77ecc",
          "type": "basic.output",
          "data": {
            "name": "led7",
            "pins": [
        ...
        {
          "id": "416a780b-bc46-4d34-80b7-f312c8b0ac68",
          "type": "basic.output",
          "data": {
            "name": "Led6",
            "pins": [
        ...
        {
          "id": "7ff781d1-03ea-48f9-9ede-4b3a7aab9103",
          "type": "basic.output",
          "data": {
            "name": "led5",
            "pins": [
        ...
        {
          "id": "1300d628-f70a-4569-93cb-3f48bbd530f3",
          "type": "basic.output",
          "data": {
            "name": "led4",
            "pins": [
        ...
        {
          "id": "a86f320b-7043-4df2-9f2b-0e63887d4b1f",
          "type": "basic.output",
          "data": {
            "name": "led3",
            "pins": [
        ...
        {
          "id": "19d83f88-2a1f-4e82-a956-75a1175bee5c",
          "type": "basic.output",
          "data": {
            "name": "reloj",
            "pins": [
        ...
        {
          "id": "4036cd07-ee6e-4ae0-ab50-c78178464a0c",
      ...
      "wires": [
        ...
        {
          "source": {
            "block": "4036cd07-ee6e-4ae0-ab50-c78178464a0c",
        ...
        },
        {
          ...
          "target": {
            "block": "5fd62d84-d7cd-4aff-93cc-a0ef14c77ecc",
            "port": "in"
          }
        },
        {
          ...
          "target": {
            "block": "416a780b-bc46-4d34-80b7-f312c8b0ac68",
            "port": "in"
          }
        },
        {
          ...
          "target": {
            "block": "7ff781d1-03ea-48f9-9ede-4b3a7aab9103",
            "port": "in"
          }
        },
        {
          ...
          "target": {
            "block": "1300d628-f70a-4569-93cb-3f48bbd530f3",
            "port": "in"
          }
        },
        {
          ...
          "target": {
            "block": "a86f320b-7043-4df2-9f2b-0e63887d4b1f",
            "port": "in"
          }
        },
        {
          ...
          "target": {
            "block": "19d83f88-2a1f-4e82-a956-75a1175bee5c",
            "port": "in"
          },
          "vertices": [
            {
